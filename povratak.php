...
<head>
  ...
  <title>POVRATAK U ŠKOLSKE KLUPE</title>
...
<div class="user-log">
  ...
  <div class="logo-headline"><a href="naslovna.php"> <img class="logo-picture" src="slike/logo3.png" alt="Logo stranice"> </a> <a class="headline" href="naslovna.php"> Elektrotehnička i prometna škola Osijek</a>
    ...
    <nav class="head-menu">
      ...
      <a class="o-nama" href="o nama.php">O nama</a>
    ...
    <div class="content">
      ...
      <section>
       <h2> POVRATAK U ŠKOLSKE KLUPE
      </h2>

       <div class="sadrzaj">
       <a href="povratak.php"><img class="slika" src="slike/povratak.jpg" alt=""></a>
       
        <p class="odlomak"><span>Poštovani učenici, nastava će se od ponedjeljka 31. siječnja 2022. održavati u školi. Nastava se idući tjedan održava po redovitom rasporedu za prijepodnevnu smjenu uz poštivanje svih epidemioloških mjera.</span></p>
