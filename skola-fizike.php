...
<head>
  ...
  <title>13. Zimska škola fizike</title>
...
<div class="user-log">
  ...
  <div class="logo-headline"><a href="naslovna.php"> <img class="logo-picture" src="slike/logo3.png" alt="Logo stranice"> </a> <a class="headline" href="naslovna.php"> Elektrotehnička i prometna škola Osijek</a>
    ...
    <div class="content">
      ...
      <section>
       <h2>13. Zimska škola fizike</h2>

       <div class="sadrzaj">
       <a href="skola-fizike.php"><img class="slika" src="slike/skola-fizike.jpg" alt=""></a>
       
        <p class="odlomak">U četvrtak  3. 3. 2022. na platformi Teams održana je <span>13. Zimska škola fizike</span> za nastavnike i učenike srednjih škola Osječko – baranjske županije. Zimsku školu fizike organiziraju Hrvatsko fizikalno društvo – podružnica Osijek i Agencija za odgoj i obrazovanje preko Županijskog stručnog vijeća nastavnika fizike. </p>

        <p class="odlomak">Ove godine učenici su kroz temu „Pitamo fizičara“ imali mogućnost postaviti raznolika pitanja iz područja Fizike, a na njih je vrlo neposredno i na jednostavan i zanimljiv način odgovarao dr.sc. <span>Saša Ceci</span> s Instituta Ruđer Bošković u Zagrebu. </p>
         
        <p class="odlomak">Na Zimskoj školi sudjelovali su i naši učenici: <span>Tin Arambašić, Ivan Balaž, Dinko Horvat i David Krauz</span> iz 3tr2 razreda s istraživačkim radom „Kosi hitac“ (mentorica <span>Snježana Švelec</span>) te <span>Eduard Štir i Bruno Medić</span> iz 4et razreda s istraživačkim radom „Amperova sila“ (mentor <span>Andrej Mijaćank</span>).</p>

        <p class="odlomak">Nadamo se da će sljedeće godine Zimska škola ponovo biti „uživo“ na Odjelu za Fiziku, jer omogućuje učenicima da na drugačiji način sudjeluju i promišljaju stvarnost očima Fizike.</p>
